                ...
                ImageCropper.prototype.draw = function (ctx) {
                    ...
                    if (this.srcImage) {
                        ...
                        if (scope.shape == 'diamond') {
                            ctx.setLineDash([6, 4]);
                            ctx.beginPath();
                            ctx.moveTo(bounds.left + (bounds.getWidth()/2), bounds.top);
                            ctx.lineTo(bounds.left + bounds.getWidth(), bounds.top + (bounds.getHeight()/2));
                            ctx.lineTo(bounds.left + (bounds.getWidth()/2), bounds.top + bounds.getHeight());
                            ctx.lineTo(bounds.left, bounds.top + (bounds.getHeight()/2));
                            ctx.closePath();
                            ctx.stroke();
                            ctx.setLineDash([]);
                        }
