            ...
            var ImageCropper = (function () {
                ...
                ImageCropper.prototype.draw = function (ctx) {
                    ...
                    if (this.srcImage) {
                        ...
                        if (scope.shape == 'diamond') {
                            ctx.setLineDash([6, 4]);
                            ctx.beginPath();

                            ctx.moveTo(bounds.left + (bounds.getWidth()*0.45), bounds.top + (bounds.getHeight()*0.10));
                            ctx.lineTo(bounds.left + (bounds.getWidth()*0.10), bounds.top + (bounds.getHeight()*0.45));
                            ctx.quadraticCurveTo(bounds.left + (bounds.getWidth()*0.05), bounds.top + (bounds.getHeight()*0.50), bounds.left + (bounds.getWidth()*0.10), bounds.top + (bounds.getHeight()*0.55));
                            ctx.lineTo(bounds.left + (bounds.getWidth()*0.45), bounds.top + (bounds.getHeight()*0.90));
                            ctx.quadraticCurveTo(bounds.left + (bounds.getWidth()*0.50), bounds.top + (bounds.getHeight()*0.95), bounds.left + (bounds.getWidth()*0.55), bounds.top + (bounds.getHeight()*0.90));
                            ctx.lineTo(bounds.left + (bounds.getWidth()*0.90), bounds.top + (bounds.getHeight()*0.55));
                            ctx.quadraticCurveTo(bounds.left + (bounds.getWidth()*0.95), bounds.top + (bounds.getHeight()*0.50), bounds.left + (bounds.getWidth()*0.90), bounds.top + (bounds.getHeight()*0.45));
                            ctx.lineTo(bounds.left + (bounds.getWidth()*0.55), bounds.top + (bounds.getHeight()*0.10));
                            ctx.quadraticCurveTo(bounds.left + (bounds.getWidth()*0.50), bounds.top + (bounds.getHeight()*0.05), bounds.left + (bounds.getWidth()*0.45), bounds.top + (bounds.getHeight()*0.10));
