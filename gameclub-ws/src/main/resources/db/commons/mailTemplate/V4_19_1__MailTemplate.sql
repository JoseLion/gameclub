UPDATE commons.mail_template SET content='<div style="width: 100%; text-align: center; background: #636363; background-image: url({{baseUrl}}:{{port}}/gameclub/open/util/getImage?name=mail-bg.png); background-size: 100%;">
	<div style="padding: 10% 10% 0% 10%;">
		...
		<div style="padding: 5%; background-color: rgba(255, 255, 255, 0.8); font-family: jaapokki; font-size: 17px; color: #071428;">
			...
			<p>Entra a <a href="{{baseUrl}}/account/messages">GameClub</a> para proceder con el pago de tu alquiler. Recuerda que debes confirmar tu dirección para poder entregar tu juego alquilado.</p>
			<p></p>
			<p>Gracias</p>
			<p></p>
