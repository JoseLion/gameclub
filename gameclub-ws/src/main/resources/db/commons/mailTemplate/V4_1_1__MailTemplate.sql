...
<div style="width: 100%; text-align: center; background: #636363; background-image: url({{baseUrl}}:{{port}}/gameclub/open/util/getImage?name=mail-bg.png); background-size: 100%;">
	<div style="padding: 10% 10% 0% 10%;">
		...
		<div style="padding: 5%; background-color: rgba(255, 255, 255, 0.8); font-family: jaapokki; font-size: 17px; color: #071428;">
			<p>Hemos procesado tu solicitud para reestablecer tu contraseña. Tu contraseña temporal asignada es: <strong>{{password}}</strong>. Ingresa a gameclub.com.ec y utiliza esta clave temporal para ingresar a tu cuenta.</p>
			<p>Si tu no solicitaste que se reestablezca tu contraseña comunícate con GameClub lo antes posible.</p>
			<p></p>
			<p>Gracias</p>
			<p></p>
