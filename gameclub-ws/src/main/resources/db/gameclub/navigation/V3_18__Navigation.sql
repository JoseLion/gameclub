...
INSERT INTO gameclub.navigation(name, route, is_abstract, icon, level, parent) VALUES
	...
	('Ingresos', 'reports.income', false, NULL, 1, (SELECT id FROM gameclub.navigation WHERE route='reports')),
	('Costos de Arriendo', 'reports.leaseCosts', false, NULL, 1, (SELECT id FROM gameclub.navigation WHERE route='reports'));
