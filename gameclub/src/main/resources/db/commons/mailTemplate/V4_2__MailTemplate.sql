...
VALUES('ACNVRF',
'<div style="width: 100%; text-align: center; background: #636363; background-image: url({{baseUrl}}:{{port}}/gameclub/open/util/getImage?name=mail-welcome-bg.png); background-size: 100%;">
	<div style="padding-top: 30px;">
		<img src="{{baseUrl}}:{{port}}/gameclub/open/util/getImage?name=mail-head-logo.png" alt="mai-head-logo.png" height="80px" />
		...
		<img src="{{baseUrl}}:{{port}}/gameclub/open/util/getImage?name=mail-how-it-works.png" alt="mail-how-it-works.png" />
